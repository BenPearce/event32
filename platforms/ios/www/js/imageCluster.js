...
function getEventRow(eventId,eventClass,datIndex){
    ...
    var titlePost = '"></div>';
    var friendImg = typeof eventList[eventId].friendIdArray[0] != "undefined"  ? friendPre + "https://graph.facebook.com/"+eventList[eventList[eventId].friendIdArray[0]].fbId +"/picture?width=100&height=100" + post : friendPre + "images/pinkX.png"+ post;
    ...
    if(eventList[eventId].friendIdArray.length == 0){
        ...
        //return '<div class="event-touched row-wrap '+eventClass+'"><div class="event-outter"><div class="event-wrapper">'+eventImg+'<div class="event-name"><div class="event-name-inner"><div class="event-title">'+eventName+'</div><div class="event-extra-info">'+venueName+" "+startTime+'</div></div></div></div><div class="ev-button-exp"><div class="ev-button-exp-out"><div class="ev-button-exp-wrap"><div data-evId="'+eventId+'" class="ev-i-button"></div><div class="ev-rsvp-button"></div><div class="ev-map-button"></div></div></div></div></div><div class="friend-outter"><div class="friend-wrapper">'+friendImg+'<div class="friend-name"><div class="friend-name-inner">'+friendName1+'</div></div></div><div class="fr-button-exp"> <div class="fr-button-exp-out"><div class="fr-button-exp-wrap"><div class="fr-i-button"></div><div class="fr-mail-button"></div><div class="fr-post-button"></div></div></div></div></div></div>';
                ...
                return '<div class="event-touched row-wrap '+eventClass+'"><div class="event-outter"><div class="event-wrapper">'+eventImg+'<div class="event-name"><div class="event-name-inner"><div class="event-title">'+eventName+'</div><div class="event-extra-info">'+venueName+" "+startTime+'</div></div></div></div><div class="ev-button-exp"><div class="ev-button-exp-wrap"><div class="ev-button-top"><div data-evId="'+eventId+'" class="ev-i-button"></div><div class="ev-rsvp-button"></div><div class="ev-map-button"></div></div><div class="ev-button-bottom"><div data-evId="'+eventId+'" class="ev-tag-button"></div><div class="ev-check-in-button"></div><div class="ev-buy-button"></div></div></div></div></div><div class="friend-outter"><div class="friend-wrapper">'+friendImg+'<div class="friend-name"><div class="friend-name-inner">'+friendName1+'</div></div></div><div class="fr-button-exp"><div class="fr-button-exp-wrap"><div class="fr-button-top"><div class="fr-i-button"></div><div class="fr-mail-button"></div><div class="fr-post-button"></div></div><div class="fr-button-bottom"><div class="fr-i-button"></div><div class="fr-mail-button"></div><div class="fr-post-button"></div></div></div></div></div></div>';
