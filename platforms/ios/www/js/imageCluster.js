...
function getEventRow(eventId,eventClass,datIndex){
    ...
    if(eventList[eventId].friendIdArray.length == 0){
        ...
        return '<div class="row-wrap '+eventClass+'">'+eventImg+friendImg+'<div class="event-wrap"><div class="row-title-wrap event-title-wrap">'+eventName+'</div></div><div id="event-ex-'+eventId+'" class="event-ex"></div></div>';
